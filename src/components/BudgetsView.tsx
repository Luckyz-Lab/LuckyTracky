    ...
    <div className="space-y-6">
      ...
      <header className="page-header relative overflow-hidden">
        ...
        <div className="relative max-w-xl">
          ...
          <h1 className="mt-2 font-display text-3xl font-bold text-ink-strong sm:text-4xl">Category budgets</h1>
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
            <AnimatePresence>
              {budgets.map((b) => {
                ...
                const barColor = isOver ? "rgb(var(--ui-danger))" : isWarn ? "rgb(var(--ui-warning))" : tone.fill;
